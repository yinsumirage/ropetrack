...
| 2026-07-05 | [0026_rope_refiner_hard_eval_probe.md](0026_rope_refiner_hard_eval_probe.md) | Held-out FreiHAND mask70 eval probe showing the first cached rope refiner worsens same-decoder aligned metrics despite fitting train cache. |
...
| 2026-07-07 | [0044_p2_multi_teacher_results.md](0044_p2_multi_teacher_results.md) | Four-teacher student results: main FreiHAND result is preserved, HO3D/HaMeR/finger_end generalization improves slightly, shuffle still collapses, and augmented remains better than noaug under noise. |
...
| 2026-07-07 | [0047_p2_multi_v2_and_p3_feature_results.md](0047_p2_multi_v2_and_p3_feature_results.md) | Multi-v2 completed: five-teacher student is a useful ablation but not better than the four-teacher release model; P3 WiLoR feature caches were generated. |
...
| 2026-07-07 | [0049_p3_v0_and_report_close_results.md](0049_p3_v0_and_report_close_results.md) | Report-close jobs completed: release model beats multi-v2 on HO3D finger_end80, apply-level latency is recorded, and P3 pooled-feature v0 is a clean negative result. |
