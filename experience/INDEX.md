...
| 2026-07-18 | [0074_hot3d_natural_visibility_and_arctic_ceiling.md](0074_hot3d_natural_visibility_and_arctic_ceiling.md) | Natural HOT3D visibility drops support rope and trusted state, a participant-disjoint linear image gate recovers the phase oracle, ARCTIC isolates an observation rather than action-capacity bottleneck, and PA/root-relative conclusions are separated. |
