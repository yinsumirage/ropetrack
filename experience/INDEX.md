...
| 2026-07-24 | [0089_direct_pose_observability_and_posterior_gate.md](0089_direct_pose_observability_and_posterior_gate.md) | Five-domain rope/token observability and K-sensitivity: five ideal ropes leave a 40D local null-space lower bound, HOT3D tokens do not selectively collapse under low visibility, and exact same-row comparison closes K=8/K=64 posterior scaling because current DirectPose already matches or beats the oracle ceiling. |
