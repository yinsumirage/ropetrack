...
| 2026-07-19 | [0079_normal_joint_no_leak_final.md](0079_normal_joint_no_leak_final.md) | Content-level audit invalidates the leaked 0076 HOT3D-all row, preserves held-out/CV evidence, and freezes the normal ARCTIC+HOT3D+HO3D v3 three-fold protocol before final scores. |
