...
from scripts.legacy.temporal.probe_visibility_gate import Gate, probabilities  # noqa: E402


def load_gate_checkpoint(path: Path, feature_dim: int) -> tuple[Gate, np.ndarray, np.ndarray, dict[str, float]]:
    # Trusted checkpoint produced by scripts/legacy/temporal/probe_image_visibility_gate.py;
