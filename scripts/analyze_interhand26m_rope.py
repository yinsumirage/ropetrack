...
from scripts.score_interhand26m import bootstrap_delta, procrustes, read_ground_truth, read_prediction
from scripts.validate_interhand26m_coordinates import INTERHAND_TO_OPENPOSE, load_mano_layers
